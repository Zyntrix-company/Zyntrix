      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-3xl lg:text-4xl font-bold mb-4 text-balance">
            From Idea to Impact: Services That Ship and Scale
          </h2>
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto text-pretty">
            Build, market, and grow with one team. We cover web and app development, SEO and digital marketing,
            customer retention, integrations and automation, AI features, testing, and deployment—so every release
            moves your metrics.
          </p>
        </div>
